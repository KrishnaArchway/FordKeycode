...
public class ADFSValidation {
   private static Logger logger = Logger.getLogger(ADFSValidation.class);
   private String s_jwtToken = "";
   private List<String> l_publicKeys = new ArrayList();
   private String s_audience = "";

   public ADFSValidation(String jwtToken) {
   ...
   public ADFSCookieBean validateAdfsToken() {
      ...
      try {
         ...
         if (token.getValidityStatus() == 5) {
            ...
            logger.warn("\nToken has an invalid signature! Bypassing this error to test the rest of the flow"); 
